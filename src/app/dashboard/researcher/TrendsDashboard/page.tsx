// src/app/dashboard/investigator/TrendsDashboard/page.tsx
import TrendsDashboard from "@/components/TrendsDashboard";

export default async function InvestigatorTrendsPage() {
  try {
    ...
    if (!(role === "investigator" || role === "institution" || role === "investigador" || role === "institucion")) {
